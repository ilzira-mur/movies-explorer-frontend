    ...
    return (
        <article className={`${props.isOpen ? `navigation navigation_type_opened` : `navigation`}`}>
            <div className="navigation__container">
                ...
                <Link to="/" onClick={props.onClose} className="link button navigation__text">Главная</Link>
                <Link to="/movies" onClick={props.onClose} className="link button navigation__text">Фильмы</Link>
                <Link to="/saved-movies" onClick={props.onClose} className="link button navigation__text">Сохранённые фильмы</Link>
                </div>
